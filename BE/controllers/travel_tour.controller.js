...
exports.cancelTravelTour = async (req, res) => {
  ...
  <body>
    <div class="email-container">
      ...
      <p>Chúng tôi rất tiếc phải thông báo rằng tour du lịch của bạn đã bị hủy. Dưới đây là thông tin chi tiết:</p>
      <ul>
        <li><strong>Tên tour:</strong> ${tour.name_tour}</li>
        <li><strong>Ngày khởi hành:</strong> ${travelTour.start_day}</li>
        <li><strong>Lý do:</strong> Tour đã bị hủy. Vui lòng liên hệ với nhân viên để được hoàn tiền.</li>
      </ul>
