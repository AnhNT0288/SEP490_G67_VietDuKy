...
import { updateRestaurant } from "../../../services/API/restaurant.service.js";
import { getLocations } from "../../../services/API/location.service.js";
import { toast } from "react-toastify";
import Select from "react-select";

// eslint-disable-next-line react/prop-types
export default function ModalUpdateRestaurant({ restaurantData, onClose, onUpdateSuccess }) {
    ...
    useEffect(() => {
        if (restaurantData) {
            setRestaurantName(restaurantData.name_restaurant || "");
            setLocationRestaurant(restaurantData.address_restaurant || "");
            setHotline(restaurantData.phone_number || "");
            setLocationId(restaurantData.location_id || ""); // lấy location_id cũ nếu có
        }
    }, [restaurantData]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await updateRestaurant(restaurantData.id, updatedRestaurant);
            ...
            toast.error("Cập nhật nhà hàng thất bại. Vui lòng thử lại.");
        } finally {
            setLoading(false);
        }
    };
            ...
            >
                <form onSubmit={handleSubmit}>
                    <div className="relative pb-3">
                        <div>
                            <h2 className="text-lg font-semibold">Cập nhật Nhà hàng</h2>
                            <p className="text-gray-500 mb-4">
                                Quản trị viên cập nhật thông tin Nhà hàng
                            </p>
                        </div>
