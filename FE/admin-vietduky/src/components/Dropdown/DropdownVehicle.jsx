...
export default function DropdownVehicle({vehicleId, onEditVehicle, onDeleteVehicle, isOpen, setOpenDropdown,}) {
    ...
    return (
        ...
        >
            <button
                onClick={(e) => {
                    e.stopPropagation();
                    setOpenDropdown((prev) => (prev === vehicleId ? null : vehicleId));
                }}
                className="p-2"
            >
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-40 bg-white shadow-md rounded-md z-10">
                    <button
                        onClick={() => {
                            setOpenDropdown(null);
                            onEditVehicle(); // Gọi hàm cập nhật phương tiện
                        }}
                    ...
                    <button
                        onClick={() => {
                            setOpenDropdown(null);
                            onDeleteVehicle(); // Gọi hàm xoá phương tiện
                        }}
